export default function Drawer({ open, onClose, order, subtotal, discount, discAmt, total, cashInput, onSetCash, change, onClearOrder, onRemoveItem, onChangeItemQty, onCheckout, onOpenHistory, onOpenDashboard }) {
    ...
    <>
      ...
      <div className={`drawer ${open ? 'open' : ''}`}>
        ...
        <div className="sidebar-always">
          <button className="history-btn" onClick={() => {onOpenHistory(); onClose()}}>🧾 Order History</button>
          <button className="history-btn dashboard-btn" onClick={() => {onOpenDashboard(); onClose()}}>📊 Sales Dashboard</button>
        </div>
      </div>
    </>
  )
